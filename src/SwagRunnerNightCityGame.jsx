...
<style>{`
.app-shell{min-height:100dvh;padding-top:env(safe-area-inset-top);padding-bottom:env(safe-area-inset-bottom);overflow:hidden}.shell-game{height:calc(100dvh - env(safe-area-inset-top) - env(safe-area-inset-bottom));display:flex;flex-direction:column}.topbar{display:flex;justify-content:space-between;gap:10px;align-items:center;padding:8px 0}.main-nav{display:flex;gap:8px;overflow:auto;padding-bottom:8px}.main-nav button{background:#111827;color:#e2e8f0;border:1px solid #334155;border-radius:999px;padding:8px 12px}.main-nav button.on{background:#facc15;color:#111827}.game-shell-main{flex:1;min-height:0;display:grid;grid-template-columns:1.2fr 1fr;gap:12px;overflow:hidden}.play-column{min-height:0;display:flex;flex-direction:column;gap:8px}.panel-column{min-height:0;overflow:auto}.canvaswrap{flex:1;min-height:220px}.canvaswrap canvas{max-height:100%;object-fit:contain}.panel{overflow:auto}@media (max-width:980px){.game-shell-main{grid-template-columns:1fr}.panel-column{order:2}.play-column{order:1}}@media (max-width:720px){.topbar{flex-wrap:wrap}.shell-game{padding-bottom:72px}.panel-column{padding-bottom:10px}.main-nav{position:fixed;left:0;right:0;bottom:0;padding:8px max(8px,env(safe-area-inset-left)) calc(8px + env(safe-area-inset-bottom)) max(8px,env(safe-area-inset-right));background:#020617;border-top:1px solid #334155;z-index:20}}
